...
def transform_coordinate(np_array):
    '''
    ...
    "Top left point"
    temp[:, 0] = np_array[:, 1] * IM_WIDTH      # x_min
    temp[:, 1] = np_array[:, 0] * IM_HEIGHT     # y_min

    "Bottom right point"
    temp[:, 2] = np_array[:, 3] * IM_WIDTH      # x_max
    temp[:, 3] = np_array[:, 2] * IM_HEIGHT     # y_max
...
while (True):
    ...
    boxes_toPrint = np.squeeze(boxes)[index]
    print("boxes", boxes_toPrint)
    print("transform_box", transform_coordinate(boxes_toPrint))
    print("scores", np.squeeze(scores)[index])
    print("classes", np.squeeze(classes)[index])
    print("------")
