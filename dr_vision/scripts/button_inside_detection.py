...
MODEL_NAME = 'inference_graph_inside'
...
PATH_TO_LABELS = os.path.join(rospack.get_path('dr_vision'), 'models', 'training_inside', 'labelmap.pbtxt')
...
class BboxDepth:
    def __init__(self):
        ...
        self.bbox_10_pose_pub = rospy.Publisher("/bbox_pose", Pose, queue_size=10)
        self.bbox_10_conf_pub = rospy.Publisher("/bbox_conf", Float32, queue_size=10)
